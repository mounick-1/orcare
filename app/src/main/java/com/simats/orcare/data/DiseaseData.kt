...
object DiseaseRepository {
    val diseases = listOf(
        ...
        Disease(
            ...
            whyItHappens = "It's a combination of factors: bacteria in your mouth (like Mutans streptococci) feed on dietary sugars and starches to create acid. Frequent snacking on sugary foods, sipping acidic drinks, and inadequate fluoride exposure make the enamel more vulnerable to these acid attacks.",
            whyNotIgnore = "Decay never stops on its own. Once it reaches the dentin, it spreads much faster toward the tooth's nerve (pulp). This leads to agonizing toothaches, abscesses (infections at the root), and can eventually require complex root canal therapy or total tooth extraction.",
        ...
        Disease(
            ...
            whatPeopleNotice = "A persistent unpleasant taste, a thick white or yellowish coating on the back of the tongue, and dry mouth (xerostomia). Since we often become accustomed to our own smell, you might only notice it through the reactions of others or by testing your breath with a clean tissue.",
        ...
        Disease(
            ...
            whatPeopleNotice = "Look for a sore or ulcer that does not heal within 14 days. Other signs include persistent red or white patches (erythroplakia or leukoplakia), a lump or thickening of the tissue, difficulty chewing or swallowing, or a feeling like something is caught in the throat.",
        ...
        Disease(
            ...
            whyItHappens = "Aggressive brushing (scrubbing) with a hard-bristled brush, gum recession due to age or gum disease, teeth grinding (bruxism), and frequent consumption of highly acidic foods/drinks that erode enamel.",
            whyNotIgnore = "Sensitivity often masks other problems like cracked teeth or deep cavities. Over time, it can lead to a 'learned' avoidance of proper cleaning in painful areas, which ironically leads to more plaque buildup and further decay.",
