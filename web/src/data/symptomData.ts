...
export const symptomsList: Symptom[] = [
  ...
  { title: 'Swelling', icon: '😫', color: '#4ADE80', bgColor: '#4ADE801A' },
  ...
  { title: 'Discolouration', icon: '🟤', color: '#FFB347', bgColor: '#FFB3471A' },
  { title: 'Yellow Deposit', icon: '🟡', color: '#FFB347', bgColor: '#FFB3471A' },
